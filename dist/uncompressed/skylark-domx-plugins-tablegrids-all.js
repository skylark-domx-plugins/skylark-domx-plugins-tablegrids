...
define('skylark-domx-plugins-tablegrids/table-grid',[
    "skylark-langx",
    "skylark-domx/query"
],function(langx,$) {
        ...
        init: function (options) {
            ...
            if (target.length > 0) {
                ...
                */
                ...
                $(tbWhole).addClass('head body foot').append(tbColGp, tbHead, tbBody, tbFoot);
                if (settings.maxBodyHeight > 0) {
                    $(tbBody).css('max-height', settings.maxBodyHeight);
                }
...
define('skylark-domx-plugins-tablegrids/main',[
    "skylark-domx-query",
    "./table-grid"
],function($) {
	return $;
});
define('skylark-domx-plugins-tablegrids', ['skylark-domx-plugins-tablegrids/main'], function (main) { return main; });


},this);
//# sourceMappingURL=sourcemaps/skylark-domx-plugins-tablegrids-all.js.map
